...
( function( $ ){
	...
	OPNControlTrigger = {
	    ...
	    {
	    	$( 'body' ).trigger( 'm-shop-control-trigger.' + hook, args );
	    },
	    ...
	    {
	    	$( 'body' ).on( 'm-shop-control-trigger.' + hook, callback );
	    },
	    ...
	    {
		    $( 'body' ).off( 'm-shop-control-trigger.' + hook, callback );
	    },
	};
...
( function( $ ){
	...
	OPNCustomizer = {
		...
		_initToggles: function()
		{
			...
			OPNControlTrigger.triggerHook( 'm-shop-toggle-control', api );
